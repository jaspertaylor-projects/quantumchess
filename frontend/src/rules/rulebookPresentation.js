...
export const RULE_GROUPS = [
  ...
  { id: 'checkmate', title: 'Checkmate & shields', label: 'Ending the game', nav: 'Checkmate & draws', rules: ['royal', 'draw'],
    ...
    note: 'Zap preserves the final King possibility by attempting a lower identity. A gold shield marks a contact with no admissible removal. Stalemate, threefold repetition and the fifty-move rule draw the game.' },
