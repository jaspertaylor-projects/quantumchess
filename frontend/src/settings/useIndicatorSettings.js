...
const ALL_ON = {
  promoted: true, checkGlow: true, typeIcons: true,
};
export const INDICATOR_PRESETS = {
  total: { ...ALL_ON },
  amateur: { ...ALL_ON, checkGlow: false },
  grandmaster: { promoted: false, checkGlow: false, typeIcons: true },
  goat: { promoted: false, checkGlow: false, typeIcons: false },
};
