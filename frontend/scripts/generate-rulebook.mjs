...
<section class="qr-turn-order" aria-labelledby="qr-turn-title"><h2 id="qr-turn-title">Turn sequence</h2><ol>${TURN_STEPS.map((step) => `<li><strong>${escape(step.title)}</strong><span>${escape(step.text)}</span></li>`).join('')}</ol></section>
